...
class HeadBar(ttk.Frame):
    def __init__(self, root):
        ...
        #     children.grid(pady=5)
    
        # self.__list_video_btn.pack(side=LEFT)
        # Label(self, text='Sort by: ').pack(side=LEFT)
        # self.__sort_by.pack(side=LEFT)
        # Label(self, text='Sort order: ').pack(side=LEFT)
            # self.__sort_order.pack(side=LEFT)
        # Label(self, text='Search: ').pack(side=LEFT)
        # self.__search_bar.pack(side=LEFT)
        #
        # for children in self.pack_info():
        #     children.pack()
